...
snp_num <- c(100, 250, 500, 800, 1000, 2000, 3000, 5000, 10000)  # SNP sizes
...
# Save classification result (e.g., accuracy) if needed
save(acc_mrmr_over, file = "acc_mrmr_overlap.RData")
