...
VCF=Buffalo_187_HC_pass_simplify_x_dl_num_qc_mm_indep.snps
VCFdot=Buffalo_187_HC_pass_simplify_x_dl_num_qc_mm_indep.snps.vcf
OUT=Buffalo_187_HC_pass_simplify_x_dl_num_qc_mm_indep_fix.snps
OUT_vcf=/path/to/data_directory/Buffalo_187_HC_pass_simplify_x_dl_num_qc_mm_indep_fix.snps.vcf.gz
