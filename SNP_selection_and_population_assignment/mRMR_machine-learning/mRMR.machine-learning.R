...
#############################################################################
## 2 Perform population classification using 4 machine learning methods for mrmr
#############################################################################
...
save(acc_mrmr1_9, file = "acc_mrmr1_9.RData")  # Save the accuracy results
save(mrmr_all_1list, file = "snp_mrmr_all_1list.RData")  # Save the SNP list for all iterations
