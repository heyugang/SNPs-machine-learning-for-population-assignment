...
#######################################################################################
## 2 Perform population classification using 4 machine learning methods for relf
#######################################################################################
# Read data
...
save(acc_relf1_10, file = "acc_relf1_10.RData")  # Save the accuracy results
save(relf_1list, file = "snp_relf_1list.RData")  # Save the SNP list for all iterations
